--[[
    ASTA REMAKE – Full Hub
    Speed Booster (LinearVelocity) integrado ao Carry Speed.
...
-- ============================================================
-- SKY THEME SYSTEM (mesmo do RXZ, mantido)
-- ============================================================
...
-- ============================================================
-- ANTIRAGDOLL, INFJUMP, ETC (mantido do RXZ)
-- ============================================================
...
local perButtonDragEnabled=true   -- <-- habilitado por padrão
...
local uiLocked=false           -- <-- usado para travar/desbloquear arraste
...
-- ============================================================
-- MOBILE BUTTONS – INDIVIDUAIS ARRASTÁVEIS (sem grid fixo)
-- ============================================================
...
-- ============================================================
-- FUNÇÕES EXISTENTES (anti-ragdoll, steal, etc) – mantidas do RXZ
-- ============================================================
...
-- ============================================================
-- GUI PRINCIPAL (ASTA REMAKE) com imagem personalizada
-- ============================================================
;(function()
...
;(function()
    ...
    -- ===== IMAGEM DE FUNDO PERSONALIZADA (do primeiro script) =====
    local BgImg=Instance.new("ImageLabel")
    BgImg.Name="BackgroundImage"; BgImg.Size=UDim2.new(1,0,1,0); BgImg.BackgroundTransparency=1
    BgImg.Image = "rbxassetid://85719239686756"  -- <-- imagem do Asta remake
...
-- KEYBIND SYSTEM (mesmo do RXZ, mantido)
...
;(function()
    ...
    -- ===== LOCK UI TOGGLE (para prender/desprender os botões) =====
...
print("ASTA REMAKE LOADED – Speed Booster integrado, botões individuais arrastáveis e imagem de fundo personalizada!")
